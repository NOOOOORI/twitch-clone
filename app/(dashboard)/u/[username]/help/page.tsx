...
const HelpPage = async () => {
  ...
  return (
    <div className="p-6 max-w-3xl space-y-10">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold">OBS Studioで配信をはじめる</h2>
        <div className="space-y-3">
          <div className="rounded-xl bg-muted p-4">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              ダッシュボードの「キー」ページで、サーバーURLとストリームキーを確認できます。
            </p>
            <Button size="sm" variant="link" className="px-0" asChild>
              <Link href={`/u/${self.username}/keys`}>
                キー&URLページを開く
              </Link>
            </Button>
          </div>
          ...
          <div className="rounded-xl bg-muted p-4">
            ...
            <Button size="sm" variant="link" className="px-0" asChild>
              <Link href={`/${self.username}`}>配信ページを開く</Link>
            </Button>
          </div>
          <div className="rounded-xl bg-muted p-4">
